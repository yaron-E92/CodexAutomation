...
label "codex:ready" "0E8A16" "Ready for Codex automation"
label "codex:in-progress" "FBCA04" "Codex automation is processing this issue"
label "codex:ready-for-review" "5319E7" "Codex PR is ready for human review"
label "codex:blocked" "B60205" "Codex automation is blocked"
